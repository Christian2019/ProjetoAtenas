...
func updateScroll(scroll):
	...
	scroll.get_node("Big/Labels/God/value3").text="zeus"
	...
	scroll.get_node("Big/Labels/Active/value").text="poseidon will create a tsunami causing "+str(warrior_dash_poseidon_chance[quality])+" SD to enemies and knockback 100."
	scroll.get_node("Big/Labels/LegendaryDivineBonus/value").text="create a kraken for 5 seconds with "+str(warrior_dash_poseidon_destructionInstinct*100)+" tentacles. each tentacle copies your current turret skill."
