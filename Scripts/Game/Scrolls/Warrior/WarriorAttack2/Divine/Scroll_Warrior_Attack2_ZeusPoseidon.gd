...
func updateScroll(scroll):
	...
	scroll.get_node("Big/Labels/God/value3").text="zeus/poseidon"
	...
	scroll.get_node("Big/Labels/Active/value").text="gain extra "+str(warrior_dash_poseidon_chance[quality])+" gain extra <valor aqui> max hp"
	scroll.get_node("Big/Labels/LegendaryDivineBonus/value").text="enemies hit by attack 2 explode, giving "+str(warrior_dash_poseidon_destructionInstinct*100)+"% damage."
