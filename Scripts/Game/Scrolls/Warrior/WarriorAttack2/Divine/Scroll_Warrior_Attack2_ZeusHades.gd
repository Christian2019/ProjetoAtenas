...
func updateScroll(scroll):
	...
	scroll.get_node("Big/Labels/God/value3").text="zeus/hades"
	...
	scroll.get_node("Big/Labels/ExtraInfo/value").text="disoriantationt*: movement and mttack speed slowed by % ammount for 10 seconds."
