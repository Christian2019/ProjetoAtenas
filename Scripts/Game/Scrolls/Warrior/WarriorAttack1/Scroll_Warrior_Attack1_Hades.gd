...
var cd
#Hades
var warrior_attack1_hades_attackSpeedBonusPercent
var warrior_attack1_hades_frenzyPercent

func start():
	sellPrice=Global.ScrollController.getCurrentScrollPrice(self)
	cd=1
	passive=AllSkillsValues.warrior_attack1_hades_passive
	#passive2=AllSkillsValues.warrior_turret_divine_poseidon_passive
	
	#Hades
	warrior_attack1_hades_attackSpeedBonusPercent=AllSkillsValues.warrior_attack1_hades_attackSpeedBonusPercent
	warrior_attack1_hades_frenzyPercent=AllSkillsValues.warrior_attack1_hades_frenzyPercent
