...
var cd
#Hades
var warrior_ultimate_hades_currentHPPercentDamage
var warrior_ultimate_hades_skeletonQuantity
var warrior_ultimate_hades_cerberusDamage

func start():
	sellPrice=Global.ScrollController.getCurrentScrollPrice(self)
	cd=AllSkillsValues.warrior_ultimate_hades_cd
	passive=AllSkillsValues.warrior_ultimate_hades_passive
	#passive2=AllSkillsValues.warrior_turret_divine_poseidon_passive
	
	#Hades
	warrior_ultimate_hades_currentHPPercentDamage=AllSkillsValues.warrior_ultimate_hades_currentHPPercentDamage
	warrior_ultimate_hades_skeletonQuantity=AllSkillsValues.warrior_ultimate_hades_skeletonQuantity
	warrior_ultimate_hades_cerberusDamage=AllSkillsValues.warrior_ultimate_hades_cerberusDamage
