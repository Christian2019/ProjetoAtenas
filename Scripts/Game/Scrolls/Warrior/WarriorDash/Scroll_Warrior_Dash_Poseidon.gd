...
func updateScroll(scroll):
	...
	scroll.get_node("Big/Labels/Active/value").text="gain "+str(warrior_dash_poseidon_chance[quality])+"% of get 1 damage every time you get hit for 5 seconds"
	scroll.get_node("Big/Labels/LegendaryDivineBonus/value").text="gain destruction instinct* "+str(warrior_dash_poseidon_destructionInstinct*100)+"%."
	scroll.get_node("Big/Labels/ExtraInfo/value").text="destruction instinct*: gain x% crit of your damage."
