...
var cd
#Poseidon
var warrior_dash_divine_poseidon_chance
var warrior_dash_divine_poseidon_destructionInstinct
...
func start():
	...
	passive2=AllSkillsValues.warrior_dash_divine_poseidon_passive
	passive=AllSkillsValues.warrior_dash_divine_zeus_passive
	cd=AllSkillsValues.warrior_dash_cd
	
	warrior_dash_divine_poseidon_chance=AllSkillsValues.warrior_dash_divine_poseidon_chance
	warrior_dash_divine_poseidon_destructionInstinct=AllSkillsValues.warrior_dash_divine_poseidon_destructionInstinct
...
func updateScroll(scroll):
	...
	scroll.get_node("Big/Labels/Passive/value").text="+ "+str(passive)+" damage "+"+ "+str(passive2)+"% damage"
	scroll.get_node("Big/Labels/Active/value").text="increase your movement speed by "+str(warrior_dash_divine_zeus_moveSpeedPercentBonus*100)+"% for "+str(warrior_dash_divine_zeus_bonusSpeedDuration)+" seconds after dashes, cannot stack. "+"gain "+str(warrior_dash_divine_poseidon_chance)+"% of get 1 damage every time you get hit for 5 seconds. "
	scroll.get_node("Big/Labels/LegendaryDivineBonus/value").text="gain ultra instinct* "+str(warrior_dash_divine_zeus_UltraInstinct.armor)+"/"+str(warrior_dash_divine_zeus_UltraInstinct.dodge*100)+"%."+"gain destruction instinct* "+str(warrior_dash_divine_poseidon_destructionInstinct*100)+"%."
	scroll.get_node("Big/Labels/ExtraInfo/value").text="ultra instinct*: increase dodge and armor by that amount. Max dodge cap at "+str(warrior_dash_divine_zeus_UltraInstinct.maxDodge)+"%"+" immortal instinct*: multiply your hp recovery by x when life is below 50%. "+"destruction instinct*: gain x% crit of your damage."
