...
func _on_scroll_1_pressed(): 
	if(scrolls[0].texture_normal==PreLoads.item):
		lastItemClicked=2
	else:
		lastItemClicked=1 
...
func _on_scroll_2_pressed():
	if(scrolls[1].texture_normal==PreLoads.item):
		lastItemClicked=2
	else:
		lastItemClicked=1
	$Warning.visible = true  
...
func _on_scroll_3_pressed():
	if(scrolls[2].texture_normal==PreLoads.item):
		lastItemClicked=2
	else:
		lastItemClicked=1
	$Warning.visible = true  
...
func _on_scroll_4_pressed():
	if(scrolls[3].texture_normal==PreLoads.item):
		lastItemClicked=2
	else:
		lastItemClicked=1
	$Warning.visible = true  
